...
grep -q "profile-mapped eval cases are missing" "${TMP_DIR}/list.err"
grep -q "07-bootstrap-artifact-hygiene.case.sh" "${TMP_DIR}/list.err"
grep -q "profile-mapped eval cases are missing" "${TMP_DIR}/run.err"
grep -q "07-bootstrap-artifact-hygiene.case.sh" "${TMP_DIR}/run.err"
